# Инструментарий для обработки транзакций
...
Модуль `src/decorators.py` содержит декоратор `log` для записи истории вызовов функций.  
Декоратор поддерживает вывод логов как в консоль, так и в файл.
...
multiply(2, 4)  # Логи выводятся в консоль

# Пример вывода:
# 2024-03-15 14:30:00 - Вызов функции multiply с аргументами: (2, 4), {}
# 2024-03-15 14:30:00 - Результат: Успешно
```
...
divide(10, 2)  # Логи сохраняются в файл operations.log
```
...
# 2024-03-15 14:35:00 - Вызов функции error_function с аргументами: (), {}
